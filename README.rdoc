...
A few Rails view helpers and accompanying CSS styles for making simple rounded form buttons and links (without Javascript). Tested in Firefox 3.5, IE 7, Safari 4, Chrome 4.
